...
public class TestState extends State {
    ...
    public TestState(StateMachineBase stateMachine, CommandXboxController controller) {
        ...
        testController.a().whileTrue(RobotContainer.elevator.test(() -> -testController.controller.getRightY()));
        ...
        active().whileTrue(RobotContainer.m_robotDrive.test(controller::getLeftX, controller::getLeftY,
