...
public class AutoBuilder {
    ...
    public static void congigureAutoOne(StateMachineBase machine, State auto) {
        ...
        pickNote1Params.put("notePos", JSONUtils.fromCoords(2.87, 2));
        PickupNoteAuto pickupNote1 = new PickupNoteAuto(machine, pickNote1Params);
        ...
        PickupNoteAuto pickupNote2 = new PickupNoteAuto(machine, pickNote2Params);
        BooleanSupplier nearLocation = Triggers.nearLocation(note2, 0.3);
        pickupNote1.withTransition(pickupNote2,
                () -> !RobotContainer.m_noteDetection.hasNote && nearLocation.getAsBoolean());
